...
export default class Test2 extends Component {
    ...
    static navigationOptions = ({navigation,screenProps}) => ({
        ...
        headerRight:(
            <Text style={{color:'red',marginRight:20}} onPress={()=>navigation.state.params.navigatePress()}>我s的</Text>
        ),
        headerLeft:(
            <Text style={{color:'red',marginRight:20}} onPress={()=>navigation.state.params.navigatePress()}>aa</Text>
        ),
    })
